...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void update(String item, int price, String spec) {
        SQLiteDatabase db = getWritableDatabase();
        // 입력한 항목과 일치하는 행의 가격 정보 수정
         db.execSQL("UPDATE MONEYBOOK SET price=" + price + " WHERE item='" + item + "';");
        db.execSQL("UPDATE MONEYBOOK SET create_at='" + spec + "' WHERE item='" + item + "';" );
        db.close();
    }
    ...
    public long row_cnt (){
        SQLiteDatabase db = getWritableDatabase();
        long count = DatabaseUtils.queryNumEntries(db, "MONEYBOOK");
